    ...
    <div className="bodyForm">
      <div className="formContainer">
        ...
        <form className="formPlace" onSubmit={handleSubmit}>
          ...
          <div className="row">
            <div className="col m-3">
              <TextField
                fieldName={"Nombre del Restaurante"}
                inputName={"name"}
                alert={nameAlert}
                maxLength={30}
              />
              ...
              />
              <TextField
                fieldName={"Tipo de Comida"}
                inputName={"cookingKind"}
                alert={cookingAlert}
                maxLength={30}
              />
              <TextArea
                fieldName={"Descripción del Restaurante"}
            ...
            <div className="col m-3">
              ...
              <div className="row">
                <div className="col">
                  <TimeField
                    fieldName={"Hora apertura"}
                    inputName={"openingTime"}
                    alert={openingAlert}
                  />
                </div>
                <div className="col">
                  <TimeField
                    fieldName={"Hora cierre"}
                    inputName={"closingTime"}
                    alert={closingAlert}
                  />
                </div>
              </div>
              <FilesUpload
                name={"Imágenes del Restaurante"}
                onChange={loadImages}
                alert={filesAlert}
              />
        ...
        <ConfirmPopup
          ...
          successActions={[
            EstablishmentService.registerRestaurant,
